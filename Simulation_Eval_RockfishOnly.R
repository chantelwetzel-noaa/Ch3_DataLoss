...
drive = "C:"
run.name = "Feb2016_Esth"#"Fall2015"
...
#Working====================================================================================================================================
#Spawning Biomass
par(mfrow= c(3,1), mar = c(0.1,1.2,0.1,1.2), oma = c(4,4,4,4), cex.axis = 1.1, cex.lab = 1.1)
...
par(mfrow= c(2,2), mar = c(1, 1, 1, 1), oma = c(4,4,2,4), cex.axis = 1.1, cex.lab = 1.1)
for (b in 1:ds){
...
par(mfrow = c(2,2), oma = c(4,4,2,4), mar = c(2,2,2,4))
for(b in 1:ds){
...
for(b in 1:ds){
  ...
  boxplot(t(rock.out[[2]]$f.selex.adj.est[b,,]), ylim = c(-10, 10))
